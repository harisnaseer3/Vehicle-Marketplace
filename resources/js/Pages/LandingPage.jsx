...
const LandingPage = ({ auth }) => {
    ...
    useEffect(() => {
        ...
        const fetchCategories = async () => {
            try {
                const response = await axios.get('/api/count-by-categories');
                if (response.data.success) {
                    const mappedCategories = response.data.data.map(cat => {
                        // Determine properties based on category name
                        let icon, description, color;

                        switch(cat.category_name.toLowerCase()) {
                            case 'cars':
                                icon = FaCar;
                        ...
                        return {
                            ...
                            description,
                            color,
                            link: `/${cat.category_name.toLowerCase().replace(' ', '')}`
                        };
                    });
                ...
                // Fallback to static categories (only 3 now)
                setCategories([
                    {
                        id: 1,
                        name: "Cars",
    ...
    if (error.stats || error.categories) {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-red-500">
                    {error.stats && <p>Error loading stats: {error.stats}</p>}
                            ...
                            <div
                                ...
                                <div className="sm:text-center lg:text-left">
                                    ...
                                    <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                        Discover, buy, and sell vehicles with confidence. Join
                                        over {Math.floor(stats.users / 10) * 10} satisfied users who trust AutoMarket for
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div className="text-center">
                            <div className="text-4xl font-bold text-blue-600 mb-2">
                                {Math.floor(stats.vehicles / 10) * 10}+
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {categories.map((category) => {
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className={`${category.color} w-12 h-12 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="text-center group">
                            <div
                                className="flex items-center justify-center h-16 w-16 rounded-full bg-blue-500 text-white mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                                <FaShieldAlt className="h-8 w-8"/>
                            </div>
                            <h3 className="text-lg font-medium text-gray-900 mb-2">Verified Listings</h3>
                            <p className="text-base text-gray-600">
                                Every vehicle goes through our comprehensive verification process to ensure quality and
                                authenticity.
                            </p>
                        </div>
                        ...
                        <div className="text-center group">
                            <div
                                className="flex items-center justify-center h-16 w-16 rounded-full bg-green-500 text-white mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="text-center group">
                            <div
                                className="flex items-center justify-center h-16 w-16 rounded-full bg-purple-500 text-white mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="text-center group">
                            <div
                                className="flex items-center justify-center h-16 w-16 rounded-full bg-red-500 text-white mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Find your perfect vehicle with detailed filters for
                                            price, year, mileage, and more.</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <FaCheckCircle className="text-green-500 w-5 h-5 mt-1 mr-3"/>
                                    <div>
                                        ...
                                        <p className="text-gray-600">Get comprehensive vehicle history including
                                            accidents, maintenance, and ownership.</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <FaCheckCircle className="text-green-500 w-5 h-5 mt-1 mr-3"/>
                                    <div>
                                        ...
                                        <p className="text-gray-600">Compare prices across similar vehicles to get the
                                            best deal.</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Communicate safely with sellers through our secure
                                            messaging system.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-lg shadow-lg p-8">
                            <div className="text-center">
                                ...
                                <h3 className="text-xl font-semibold text-gray-900 mb-4">Trusted by {Math.floor(stats.users / 100) * 100}+ Users</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><Link to="/vehicles" className="text-gray-400 hover:text-white">Browse Cars</Link>
                                </li>
                                <li><Link to="/bikes" className="text-gray-400 hover:text-white">Browse Bikes</Link>
                                </li>
                                <li><Link to="/post/create" className="text-gray-400 hover:text-white">Sell
                                    Vehicle</Link></li>
                                <li><Link to="/search" className="text-gray-400 hover:text-white">Advanced Search</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
