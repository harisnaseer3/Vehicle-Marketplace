        ...
        const fetchFavorites = async () => {
            if (user) {
                try {
                    ...
                    const favoriteIds = response.data.data.map(vehicle => vehicle.id);
                ...
                <div className="container mx-auto px-4 py-12">
                        ...
                        <ol className="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div className="flex items-center">
                                    <svg className="w-3 h-3 mx-1 text-blue-300" aria-hidden="true"
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-blue-100 text-lg">Discover your perfect vehicle from our extensive
                                collection</p>
                        </div>
                        <Link
                            to="/post/create"
            ...
            <div className="container mx-auto px-4 py-8">
                        ...
                        {showAdvancedFilters && (
                            <div className="mt-6 pt-6 border-t border-gray-200">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    <div>
                                        <label
                                            className="block text-sm font-medium text-gray-700 mb-1">Transmission</label>
                                        <select
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Fuel
                                            Type</label>
                                        <select
                                            name="fuel_type"
                ...
                {vehicles.length > 0 ? (
                                    ...
                                    <div key={vehicle.id}
                                        ...
                                        <div
                                            ...
                                            <div className="absolute top-3 left-3 z-10 flex flex-col gap-2">
                                                {vehicle.certified === 1 && (
                                                    <div
                                                        className="bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg flex items-center">
                                            ...
                                            <span
                                                className={`text-xs font-bold px-3 py-1 rounded-full border ${getConditionColor(vehicle.condition)}`}>
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex items-center text-sm text-gray-500 mb-4">
                                                ...
                                                <span
                                                    className="capitalize">{vehicle.location?.replace('-', ' ')}</span>
                                            </div>
                                                ...
                                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                                                    <div className="flex items-center text-gray-600">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div
                                                                className="font-medium">{vehicle.mileage?.toLocaleString()} km
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-center text-gray-600">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div
                                                                className="font-medium capitalize">{vehicle.fuel_type}</div>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-center text-gray-600">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div
                                                                className="font-medium capitalize">{vehicle.transmission_type}</div>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-center text-gray-600">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div
                                                                className="font-medium capitalize">{vehicle.color}</div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="mt-2 text-gray-600">Try adjusting your search or filter to find what you're
                            looking for.</p>
                    </div>
                )}
