...
const AllBikes = () => {
            ...
            try {
                ...
                if (response.data.success && response.data.data) {
                    ...
                    setStats({
                        ...
                        certified: response.data.data.data.filter(bike => bike.certified === 1).length
                    });
                } else {
    ...
    const toggleFavorite = async (bikeId) => {
        ...
        try {
            const response = await axios.post('favorites/toggle', { post_id: bikeId });
            ...
            <nav className="flex mb-6" aria-label="Breadcrumb">
                <ol className="inline-flex items-center space-x-1 md:space-x-3">
                    <li className="inline-flex items-center">
                                <Link to="/" className="inline-flex items-center text-sm font-medium text-red-200 hover:text-white">
                            Home
                        </Link>
                    </li>
                    <li>
                        <div className="flex items-center">
                                    <svg className="w-3 h-3 mx-1 text-red-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-red-100 text-lg">Discover your perfect ride from our extensive collection</p>
                        </div>
                        <Link
                            to="/post/create"
            ...
            {bikes.length > 0 ? (
                <>
                    ...
                    <div key={bike.id}
                                ...
                                // List View
                                <div key={bike.id} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                                                <div className="flex items-center text-gray-600">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="font-medium">{bike.mileage?.toLocaleString()} km</div>
                                                    </div>
                                                </div>
                                                <div className="flex items-center text-gray-600">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="font-medium">{getEngineSize(bike.engine_size)}</div>
                                                    </div>
                                                </div>
                                                <div className="flex items-center text-gray-600">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="font-medium capitalize">{bike.fuel_type}</div>
                                                    </div>
                                                </div>
                                                <div className="flex items-center text-gray-600">
