    ...
    public function run(): void
    {
        ...
        for ($i = 1; $i <= 10; $i++) {
            Post::create([
                ...
                'city_id' => rand(1, 6), // Assuming 6 cities
                'location' => ['hv-13', 'phase-5', 'phase-8', 'blue-area', 'behria', 'saddar'][rand(0, 5)],
                'vehicle_registration_id' => rand(1, 3), // 1 = registered, 2 = unregistered
